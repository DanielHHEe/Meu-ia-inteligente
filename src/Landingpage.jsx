...
const HeroSection = ({ onCreateContract }) => {
  ...
  useEffect(() => {
    const target = 500, step = Math.ceil(target / 60);
    let c = 0;
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#080d14]">
      ...
      <motion.div style={{ y: contentY, opacity: heroOpacity }} className="max-w-7xl mx-auto px-6 md:px-10 relative z-10 pt-14 md:pt-14 w-full">
